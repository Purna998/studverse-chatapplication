...
const GroupsSection = () => {
  ...
  const confirmDeleteGroup = async () => {
    ...
    try {
      ...
      const response = await api.admin.deleteGroup(deletingGroup.id);
      
      setDeleteResult({
        success: true,
        message: `Group "${deletingGroup.name}" deleted successfully`
      });
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-10 w-10">
                        ...
                        <div className={`h-10 w-10 rounded-lg bg-green-600 flex items-center justify-center ${group.image ? 'hidden' : ''}`}>
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="mb-6">
              <p className="text-sm text-gray-600">
                Are you sure you want to delete group <strong>"{deletingGroup.name}"</strong>? This action cannot be undone.
              </p>
